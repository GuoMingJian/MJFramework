...
- (void)layoutSubviews {
    ...
    if (self.limitLength && self.wordCountLabel) {
         ...
         */
        NSLog(@"%@ --- %@",NSStringFromCGRect(self.frame),NSStringFromCGSize(self.contentSize));
        CGFloat y = self.contentSize.height > self.frame.size.height ? self.contentSize.height - 10 : self.frame.size.height - 20;
        self.wordCountLabel.frame = CGRectMake(0, y, CGRectGetWidth(self.frame) - 10, 20);
    }
