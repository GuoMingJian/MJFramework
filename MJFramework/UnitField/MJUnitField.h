...
@protocol MJUnitFieldDelegate;

IB_DESIGNABLE

/// UnitField
@interface MJUnitField : UIControl <UITextInput>

@property (nullable, nonatomic, weak) id<MJUnitFieldDelegate> delegate;
...
@protocol MJUnitFieldDelegate <UITextFieldDelegate>

@optional
- (BOOL)unitField:(MJUnitField *)uniField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string;
