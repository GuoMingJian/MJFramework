...
- (void)initialize {
    ...
    MJUnitFieldTextPosition *point = [MJUnitFieldTextPosition positionWithOffset:0];
    UITextRange *aNewRange = [MJUnitFieldTextRange rangeWithStart:point end:point];
...
- (nullable NSString *)textInRange:(MJUnitFieldTextRange *)range {
    return self.text;
}

- (void)replaceRange:(MJUnitFieldTextRange *)range
...
- (UITextPosition *)beginningOfDocument {
    return [MJUnitFieldTextPosition positionWithOffset:0];
}
...
- (UITextPosition *)endOfDocument {
    ...
    return [MJUnitFieldTextPosition positionWithOffset:self.text.length - 1];
}
...
- (nullable UITextRange *)textRangeFromPosition:(MJUnitFieldTextPosition *)fromPosition
                                     toPosition:(MJUnitFieldTextPosition *)toPosition {
    NSRange range = NSMakeRange(MIN(fromPosition.offset, toPosition.offset), ABS(toPosition.offset - fromPosition.offset));
    return [MJUnitFieldTextRange rangeWithRange:range];
}

- (nullable UITextPosition *)positionFromPosition:(MJUnitFieldTextPosition *)position
                                           offset:(NSInteger)offset {
    NSInteger end = position.offset + offset;
    if (end > self.text.length || end < 0)
        return nil;
    return [MJUnitFieldTextPosition positionWithOffset:end];
}

- (nullable UITextPosition *)positionFromPosition:(MJUnitFieldTextPosition *)position
                                      inDirection:(UITextLayoutDirection)direction
                                           offset:(NSInteger)offset {
    return [MJUnitFieldTextPosition positionWithOffset:position.offset + offset];
}


/* Simple evaluation of positions */
- (NSComparisonResult)comparePosition:(MJUnitFieldTextPosition *)position
                           toPosition:(MJUnitFieldTextPosition *)other {
    if (position.offset < other.offset) return NSOrderedAscending;
    if (position.offset > other.offset) return NSOrderedDescending;
    return NSOrderedSame;
}

- (NSInteger)offsetFromPosition:(MJUnitFieldTextPosition *)from
                     toPosition:(MJUnitFieldTextPosition *)toPosition {
...
- (nullable UITextRange *)characterRangeByExtendingPosition:(MJUnitFieldTextPosition *)position
                                                inDirection:(UITextLayoutDirection)direction { return nil; }


/* Writing direction */
- (UITextWritingDirection)baseWritingDirectionForPosition:(MJUnitFieldTextPosition *)position
                                              inDirection:(UITextStorageDirection)direction { return UITextWritingDirectionNatural; }
- (void)setBaseWritingDirection:(UITextWritingDirection)writingDirection forRange:(UITextRange *)range {}


/* Geometry used to provide, for example, a correction rect. */
- (NSArray<UITextSelectionRect *> *)selectionRectsForRange:(MJUnitFieldTextRange *)range { return nil; }
- (CGRect)firstRectForRange:(MJUnitFieldTextRange *)range { return CGRectNull; }
- (CGRect)caretRectForPosition:(MJUnitFieldTextPosition *)position { return CGRectNull; }
